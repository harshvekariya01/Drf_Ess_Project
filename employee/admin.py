...
from .models import designation,department,leave_type,leave,attendence,Employee
...
class Employee1(admin.ModelAdmin):
    list_display = ['username','first_name','last_name','dob','address','phone_no','email','password','employee_designation','employee_department','acess_type']
